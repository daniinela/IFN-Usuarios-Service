...
// RUTAS PROTEGIDAS - USUARIOS (requieren token)
...
// RUTAS PROTEGIDAS - ROLES (requieren token)
...
// RUTAS SOLO SUPER ADMIN - ROLES

router.post('/roles', verificarToken, verificarSuperAdmin, RolesController.create);

// RUTAS PROTEGIDAS - CUENTAS ROL (requieren token)
...
// RUTAS PROTEGIDAS - PRIVILEGIOS (requieren token)
...
// RUTAS SOLO SUPER ADMIN - PRIVILEGIOS

router.post('/privilegios', verificarToken, verificarSuperAdmin, PrivilegiosController.create);
